...
<?php include('../header.php');?>
  	<div id="main">
		<section class="step2">
		<p align="center"><img src="<?php echo $path;?>img/bonus.jpg" width="813" height="803" alt="Bonuses for coming to the <?php echo $lengthNumeric;?> Day Event in <?php echo $city . ", " . $stateAbbv;?> on <?php echo $date;?>"></p>
		...
		<input value="75d35814bc94d62023d9d32acbc9a9ad" type="hidden" name="infusion_xid" id="infusion_xid" />
		<input value="CustomFormSale" type="hidden" name="infusion_type" id="infusion_type" />
		<input value="Wealth Conference Baltimore, MD Sept 15 2012 - EM" type="hidden" name="infusion_name" id="infusion_name" />
	...
	<table cellspacing="0" cellpadding="5" class='sale-table' width="600" align="center">
		...
		<tr>
			...
			<input type="image" src="<?php echo $path;?>img/btn-ordernow.jpeg" name="Order" value="Order" id="Order" class="default-input sale-orderbutton np inf-button" />
			</td>
		</tr>
	</table>
		  </form>
