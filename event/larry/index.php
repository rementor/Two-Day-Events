...
?>
  	<div id="main">
		<section class="step1">
			<p align="center">
			<img src="img/FilthyRichesCourse.jpeg" width="513" height="256" alt="Larry Goins Filty Riches Course">
			</p>
			...
			<input name="infusion_xid" value="8a08b9b0ffa91655c882728f77280796" type="hidden" id="infusion_xid" />
			<input name="infusion_type" value="CustomFormSale" type="hidden" id="infusion_type" />
			<input name="infusion_name" value="Larry Goins Filthy Riches" type="hidden" id="infusion_name" />
