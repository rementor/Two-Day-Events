...
include('../../header.php');
$infusion_xid = $_GET['infusion_xid'];
$infusion_name = $_GET['infusion_name'];
$PayTotal_A = $_GET['PayTotal_A'];
$prod_title = $_GET['prod_title'];
?>
  	<div id="main">
		<section class="step1">
			<p align="center">
			<img src="img/ahrcombined.png" width="460" height="270" alt="Apartment House Riches">
			</p>
			...
			<input name="infusion_xid" value="<?php echo $infusion_xid;?>" type="hidden" id="infusion_xid" />
			<input name="infusion_type" value="CustomFormSale" type="hidden" id="infusion_type" />
			<input name="infusion_name" value="<?php echo $infusion_name;?>" type="hidden" id="infusion_name" />
					...
					<td>
						<table>
							<tr>
								...
								<input name="PayTotal_A" value="<?php echo $PayTotal_A;?>" type="hidden" id="PayTotal_A" />
								<input name="PlanCount_A" value="1" type="hidden" id="PlanCount_A" />
								</td>
								<td class='sale-productdata' nowrap="nowrap">
								Total amount of <?php echo $PayTotal_A;?> charged today.
								</td>
							</tr>
						</table>
					</td>
					<td class='sale-productdata'>
					<b><?php echo $PayTotal_A;?></b>
					</td>
				</tr>
			</table>
			</div>
