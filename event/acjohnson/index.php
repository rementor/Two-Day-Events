...
?>
  	<div id="main">
		<section class="step1">
			<p align="center">
			<img src="img/productshot.jpg" width="680" height="420" alt="AC Johnson's Bus Tour">
			</p>
			...
			<input name="infusion_xid" value="7a5baf6bb71697c4eb439a7e3111dde6" type="hidden" id="infusion_xid" />
			<input name="infusion_type" value="CustomFormSale" type="hidden" id="infusion_type" />
			<input name="infusion_name" value="AC Johnson Bus Tour" type="hidden" id="infusion_name" />
				...
				<tr>
					<td>
						<table>
							<tr>
								<td>
								<input type="radio" class="radio" name="PurchaseType" value="B" onClick="calcTotals()">
								<input name="PayTotal_B" value="494.0" type="hidden" id="PayTotal_B" />
								<input name="PlanCount_B" value="1" type="hidden" id="PlanCount_B" />
								</td>
								<td class='sale-productdata' nowrap="nowrap">
								Total amount of $494.00 (Save $100!).
								</td>
							</tr>
						</table>
					</td>
