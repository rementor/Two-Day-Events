...
?>
  	<div id="main">
		<section class="step1">
			<p align="center">
			<img src="img/TDBK-package.png" width="650" height="273" alt="Patrick James' Tax Deduction Business Kit">
			</p>
			...
			<input name="infusion_xid" value="fcc73a20ae95bbc8eb8ade0cdfa1494d" type="hidden" id="infusion_xid" />
			<input name="infusion_type" value="CustomFormSale" type="hidden" id="infusion_type" />
			<input name="infusion_name" value="Tax Deduction Business Kit Form" type="hidden" id="infusion_name" />
			...
			<table cellpadding="5" border="0" align="center">
				<tr>
					...
					<b>Tax Deduction Business Kit</b>
					</td>
