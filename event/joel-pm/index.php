...
?>
  	<div id="main">
		<section class="step1">
			<p align="center">
			<img src="img/privatemoneycombined.jpeg" width="500" height="419" alt="Private Money Creative Financing">
			</p>
			...
			<input name="infusion_xid" value="48a34bf63a47bf2aab929303c12d53b4" type="hidden" id="infusion_xid" />
			<input name="infusion_type" value="CustomFormSale" type="hidden" id="infusion_type" />
			<input name="infusion_name" value="2 Day Online: Private Money" type="hidden" id="infusion_name" />
			...
			<table cellpadding="5" border="0" align="center">
					...
					<td>
						<table>
							<tr>
								...
								<input name="PayTotal_A" value="995.0" type="hidden" id="PayTotal_A" />
				...
				<tr>
					<td width="80%" class='sale-productheader'>
					<b>Private Money Target Software</b>
					</td>
					<td width="20%" class='sale-productheader' valign='top'>
					Amt
					</td>
				...
				<tr>
					<td>
						<table>
							<tr>
								<td>
								<input name="SubscriptionPlanWait" id="SubscriptionPlanWait" type="hidden" value="0" />
					...
					<td>
					<strong>$79.00 Every Month</strong>
					</td>
				</tr>
			</table>
			</div>
