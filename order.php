...
<?php include('header.php');?>
  	<div id="main">
		...
		<input value="<?php echo $infusion_xid;?>" type="hidden" name="infusion_xid" id="infusion_xid" />
		<input value="CustomFormSale" type="hidden" name="infusion_type" id="infusion_type" />
		<input value="<?php echo $infusion_name;?>" type="hidden" name="infusion_name" id="infusion_name" />
